...
const SOILS = [
    {
        ...
        local: "regur",
        where: "the Deccan",
        body: "Ground-up lava, and a great deal of it. Sixty-six million years ago the Deccan opened and bled basalt across half a subcontinent; what weathered out of all that is a black clay so thirsty it swells shut around rain.",
        fact: "Come March it dries and splits — fissures a hand wide running an arm deep, swallowing loose topsoil and turning the field over with no plough and no bullock. The ground works itself.",
    },
    {
        name: "Alluvial",
        local: "the delta soils",
        where: "the Godavari and Krishna deltas",
        body: "Borrowed ground. Every grain of it was highland once, worked loose upstream and carried until the water lost its nerve, slowed, and set the load down. Dark, heavy, and made new again each flood.",
        fact: "A delta field can be younger than the crop standing in it, and the river has not finished. Ground that arrives, by instalment, from somewhere else.",
    },
    {
        name: "Light sandy loam",
        local: "the light soils",
        where: "the Karnataka plateau",
        body: "Pale, thin, and forgiving of nothing. Rain falls through it the way rain falls through a sieve, and whatever a plant wants it has to go down and find.",
        fact: "Hungry ground makes the better leaf. A plant made to work puts less into growing wide and more into what ends up in the smoke — the same bargain a vine strikes on a stony hillside.",
    },
    {
        name: "Red laterite",
        local: "lateritic soil",
        where: "the coast and the Western Ghats",
        body: "Rust, essentially. Rain has spent millions of years rinsing everything soluble out of this ground and leaving the iron standing, and iron left in the open does what iron does.",
        fact: "Wet, it cuts like cheese. Dry, it sets like fired brick. Blocks sawn out of these hillsides are still holding up churches and forts along the coast four centuries on.",
    },
]
